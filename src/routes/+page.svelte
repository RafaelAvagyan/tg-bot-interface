...
<div class="main">
  {@html `<script
    ...
    ></script>`}
  <!-- {@html `<script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-login="CreateTodoBot" data-size="large" data-onauth="onTelegramAuth(user)" data-request-access="write"></script>
